...
namespace FourthCoffee.TypeInspector
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void inspectButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            this.RenderConstructors(type.GetConstructors());

            this.RenderFields(type.GetFields());
        }
        ...
        private void RenderConstructors(ConstructorInfo[] constructors)
        {
            foreach (var constructor in constructors)
            {
                this.membersList.Items.Add(String.Format(
                    "(Constructor) {0} {1}",
                    constructor.DeclaringType.ToString(),
                    constructor.Name));
            }
        }
        private void RenderFields(FieldInfo[] fields)
        {
            foreach (var field in fields)
            {
                this.membersList.Items.Add(String.Format(
                    "(Fields) {0} {1}",
                    field.DeclaringType.ToString(),
                    field.Name));
            }
        ...
        private void btnLoadFrom_Click(object sender, RoutedEventArgs e)
        {
            ...
            var assembly2 = Assembly.ReflectionOnlyLoad(rawBytes);

            var assemblyPath2 = "C:\\FourthCoffee\\Libs\\FourthCoffee.Service.ExceptionHandling.dll";
            var assembly3 = Assembly.ReflectionOnlyLoadFrom(assemblyPath2);
        }
    }
}
