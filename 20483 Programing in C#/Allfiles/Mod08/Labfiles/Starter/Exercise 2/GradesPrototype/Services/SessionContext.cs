...
namespace GradesPrototype.Services
{
    ...
    public class SessionContext
    {
        ...
        public static Grades.DataModel.SchoolGradesDBEntities 
            DBContext = new SchoolGradesDBEntities(new Uri("http://localhost:1655/Services/GradesWebDataService.svc"));
