...
1. Read the lab scenario to the students and point out that they should read each scenario before attempting the lab for a module.
   ...
   ```
   Eres un desarrollador web que trabaja para una organización que crea sitios web para respaldar conferencias. Se le ha pedido que cree un sitio web para ContosoConf, una conferencia que muestra las últimas herramientas y técnicas para crear aplicaciones web HTML5.
   Decide comenzar por crear un sitio web prototipo que consta de una página de inicio que actúa como página de inicio para los asistentes a la conferencia y una página Acerca de que describe el propósito de la conferencia. En laboratorios posteriores, mejorará estas páginas y agregará páginas que permitan a los asistentes registrarse para la conferencia y proporcionar información sobre las sesiones de la conferencia.
   ```
