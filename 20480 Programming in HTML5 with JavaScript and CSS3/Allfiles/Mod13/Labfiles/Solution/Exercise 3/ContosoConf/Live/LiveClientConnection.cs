...
namespace ContosoConf.Live
{
    class LiveClientConnection
    {
        ...
        void SimulateOtherClients()
        {
            ...
            Task.Delay(200)
                 .ContinueWith(_ => Questions.Add(badQuestion)) ; ;
            Task.Delay(500)
            ...
            Task.Delay(3000)
                .ContinueWith(_ =>
                {
                Questions.Add(new Question(4, "This is the next winter of 2020?"));
                });

            Task.Delay(5000)
                .ContinueWith(_ => Questions.Add(
                    new Question(5, "How much of CSS3 can I use right now?")
                ));
