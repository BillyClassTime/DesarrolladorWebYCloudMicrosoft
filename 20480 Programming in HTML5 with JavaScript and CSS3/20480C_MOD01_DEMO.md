...
1. Read the lab scenario to the students and point out that they should read each scenario before attempting the lab for a module.
   ...
   ```
   ContosoConf es una conferencia técnica anual que describe las últimas herramientas y técnicas para crear aplicaciones web HTML5. Los organizadores de la conferencia han creado un sitio web para respaldar la conferencia, utilizando las mismas tecnologías que muestra la conferencia.
   Usted es un desarrollador que crea sitios web utilizando HTML, CSS y JavaScript, y se le ha dado acceso al código del sitio web para la última conferencia. Decide echar un vistazo a esta aplicación web para ver cómo funciona y cómo el desarrollador usó Visual Studio 2017 para crearla.
   ```
