...
1. Read the lab scenario to the students and point out that they should read each scenario before attempting the lab for a module.
   ...
   ```
   Los asistentes que quieran asistir a ContosoConf deberán registrarse y proporcionar sus detalles. Se le ha pedido que agregue una página al sitio web de ContosoConf que implementa un formulario de registro de asistentes.
   El código del lado del servidor ya existe para procesar los datos de los asistentes. Sin embargo, la página de registro realiza una validación mínima y no es fácil de usar. Ha decidido agregar la validación del lado del cliente al formulario para mejorar la precisión de los datos de registro ingresados por los asistentes y brindar una mejor experiencia de usuario.
   ```
