...
23.	Verify that the **location.htm** file contains the **&lt;script src="/dist/location.bundle.js" type="module"&gt;** element near the end. Exactly in **<section class="page-section location">...** Line 104
24.	Find the **&lt;section class="travel"&gt;** element. Line 40
25.	Verify that this element contains the following HTML markup:
  ...
  ```
26.	Find the **&lt;section class="venue"&gt;** element. Linea 54
...
29.	Find the **&lt;section class="page-section live"&gt;** element. Line 38.
30.	Verify that this section contains the following HTML markup:
  ...
  ```
31.	Verify that the **live.htm** file contains the following **&lt;script&gt;** element near the end: Linea 69.
  ```html
    <script src="/dist/live.bundle.js" type="module">
  ```
32.	In **Solution Explorer**, double-click **feedback.htm**.
33.	Find the **&lt;section class="page-section feedback"&gt;** element. Linea 38
