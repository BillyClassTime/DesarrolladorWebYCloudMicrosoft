...
namespace BlueYonder.Flights.DAL.Database
{
    public static class DbInitializer
    {
        ...
        private static void Seed(PassengerDbContext context)
        {
            ...
            {
                new Passenger(){ Name = "AJon Due", Email = "jond@outlook.com"},
                new Passenger(){ Name = "BJon Due2", Email = "jond2@outlook.com"},
                new Passenger(){ Name = "CJon Due3", Email = "jond3@outlook.com"}
            };
