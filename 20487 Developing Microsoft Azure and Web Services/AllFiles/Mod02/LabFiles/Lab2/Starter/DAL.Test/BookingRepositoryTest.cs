...
namespace DAL.Test
{
    ...
    {
        private DbContextOptions<MyDbContext> _options = new DbContextOptionsBuilder<MyDbContext>().UseSqlite(@"Data Source=D:\20487D\AllFiles\Mod02\LabFiles\Lab2\Database\SqliteHotel.db").Options;

        [TestMethod]
        public async Task AddTwoBookingTest()
        {
